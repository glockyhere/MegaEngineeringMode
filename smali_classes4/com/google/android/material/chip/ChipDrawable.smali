...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0}, Lcom/google/android/material/internal/TextDrawableHelper;-><init>()V
...
.method private compositeSurfaceBackgroundColor(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    .param p2, "surfaceColor"    # Landroid/content/res/ColorStateList;
...
.method private onStateChange([I[I)Z
    ...
    iget-object v2, p0, Lcom/google/android/material/chip/ChipDrawable;->chipSurfaceColor:Landroid/content/res/ColorStateList;

    const/4 v3, 0x0

    if-eqz v2, :cond_0

    iget v4, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChipSurfaceColor:I
    ...
    .line 994
    .local v2, "newChipSurfaceColor":I
    :goto_0
    iget v4, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChipSurfaceColor:I
    ...
    .line 995
    iput v2, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChipSurfaceColor:I
    ...
    .line 999
    :cond_1
    iget-object v4, p0, Lcom/google/android/material/chip/ChipDrawable;->chipBackgroundColor:Landroid/content/res/ColorStateList;
    ...
    .line 1003
    .local v4, "newChipBackgroundColor":I
    :goto_1
    iget v5, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChipBackgroundColor:I
    ...
    .line 1008
    :cond_3
    iget-object v5, p0, Lcom/google/android/material/chip/ChipDrawable;->chipStrokeColor:Landroid/content/res/ColorStateList;

    if-eqz v5, :cond_4

    iget v6, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChipStrokeColor:I
    ...
    .line 1013
    iput v5, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChipStrokeColor:I
    ...
    .line 1017
    :cond_5
    iget-object v6, p0, Lcom/google/android/material/chip/ChipDrawable;->compatRippleColor:Landroid/content/res/ColorStateList;

    if-eqz v6, :cond_6

    iget v7, p0, Lcom/google/android/material/chip/ChipDrawable;->currentCompatRippleColor:I
    ...
    .line 1021
    .local v6, "newCompatRippleColor":I
    :goto_3
    iget v7, p0, Lcom/google/android/material/chip/ChipDrawable;->currentCompatRippleColor:I
    ...
    .line 1022
    iput v6, p0, Lcom/google/android/material/chip/ChipDrawable;->currentCompatRippleColor:I

    .line 1023
    iget-boolean v7, p0, Lcom/google/android/material/chip/ChipDrawable;->useCompatRipple:Z
    ...
    .line 1028
    :cond_7
    iget-object v7, p0, Lcom/google/android/material/chip/ChipDrawable;->textDrawableHelper:Lcom/google/android/material/internal/TextDrawableHelper;

    .line 1029
    invoke-virtual {v7}, Lcom/google/android/material/internal/TextDrawableHelper;->getTextAppearance()Lcom/google/android/material/resources/TextAppearance;
    ...
    iget v8, p0, Lcom/google/android/material/chip/ChipDrawable;->currentTextColor:I

    .line 1034
    invoke-virtual {v7, p1, v8}, Landroid/content/res/ColorStateList;->getColorForState([II)I
    ...
    .line 1037
    iput v7, p0, Lcom/google/android/material/chip/ChipDrawable;->currentTextColor:I
    ...
    invoke-static {v8, v9}, Lcom/google/android/material/chip/ChipDrawable;->hasState([II)Z

    move-result v8

    if-eqz v8, :cond_a

    iget-boolean v8, p0, Lcom/google/android/material/chip/ChipDrawable;->checkable:Z
    ...
    .line 1042
    .local v8, "newChecked":Z
    :goto_5
    iget-boolean v9, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChecked:Z

    if-eq v9, v8, :cond_b

    iget-object v9, p0, Lcom/google/android/material/chip/ChipDrawable;->checkedIcon:Landroid/graphics/drawable/Drawable;
    ...
    .line 1044
    .local v9, "oldChipIconWidth":F
    iput-boolean v8, p0, Lcom/google/android/material/chip/ChipDrawable;->currentChecked:Z
    ...
    .line 1053
    .end local v9    # "oldChipIconWidth":F
    .end local v10    # "newChipIconWidth":F
    :cond_b
    iget-object v9, p0, Lcom/google/android/material/chip/ChipDrawable;->tint:Landroid/content/res/ColorStateList;

    if-eqz v9, :cond_c

    iget v3, p0, Lcom/google/android/material/chip/ChipDrawable;->currentTint:I

    invoke-virtual {v9, p1, v3}, Landroid/content/res/ColorStateList;->getColorForState([II)I
    ...
    .local v3, "newTint":I
    :cond_c
    iget v9, p0, Lcom/google/android/material/chip/ChipDrawable;->currentTint:I
    ...
    iget-object v10, p0, Lcom/google/android/material/chip/ChipDrawable;->tintMode:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p0, v9, v10}, Lcom/google/android/material/drawable/DrawableUtils;->updateTintFilter(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object v9

    iput-object v9, p0, Lcom/google/android/material/chip/ChipDrawable;->tintFilter:Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 1060
    :cond_d
    iget-object v9, p0, Lcom/google/android/material/chip/ChipDrawable;->chipIcon:Landroid/graphics/drawable/Drawable;

    invoke-static {v9}, Lcom/google/android/material/chip/ChipDrawable;->isStateful(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v9, p1}, Landroid/graphics/drawable/Drawable;->setState([I)Z
    ...
    .line 1066
    :cond_f
    iget-object v9, p0, Lcom/google/android/material/chip/ChipDrawable;->closeIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v9, p2}, Landroid/graphics/drawable/Drawable;->setState([I)Z
